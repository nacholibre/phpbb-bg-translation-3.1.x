...
$lang = array_merge($lang, array(
	...
	'FORUM_ADDRESS_EXPLAIN'		=> 'Това е URL адресът към вашия форум, пример <samp>https://www.example.com/phpBB2/</samp>.',
	...
	'SUPPORT_BODY'				=> 'Пълна безплатна поддръжка ще бъде осигурена за phpBB3. Това включва:</p><ul><li>инсталация</li><li>конфигурация</li><li>технически въпроси</li><li>проблеми свързани с потенциален бъг в софтуера ни</li><li>обновяване</li><li>конвертиране от phpBB2 до phpBB3</li><li>конвертиране от други системи (моля прочетете <a href="https://www.phpbb.com/community/viewforum.php?f=65">форум конвертиране</a>)</li></ul><p>Знаем, че все още има потребители използващи BETA версии на нашия софтуер и затова ги стимулираме да преминат към финалната STABLE версия.</p><h2>Модификации / Стилове</h2><p>За проблеми свързани с различните модификации, моля пишете във <a href="https://www.phpbb.com/community/viewforum.php?f=81">форум модификации</a>.<br />За проблеми свързани със стиловете, моля пишете във <a href="https://www.phpbb.com/community/viewforum.php?f=80">форум стилове</a>.<br /><br />При други въпроси, моля посетете<a href="https://www.phpbb.com/support/">секцията за поддръжка</a><br /><br />',
...
$lang = array_merge($lang, array(
	...
	'NO_UPDATE_FILES_OUTDATED'		=> 'Не е намерена валидна директория за конвертиране уверете се, че сте качили всички файлове.<br /><br />Инсталацията <strong>не</strong> е обновена до най-новата версия. Ъпдейти съществуват за вашата версия на phpBB %1$s, посетете <a href="https://www.phpbb.com/downloads.php" rel="external">https://www.phpbb.com/downloads.php</a> за повече информация, намерете правилния пакет за обновяване от версия %2$s до версия %3$s.',
