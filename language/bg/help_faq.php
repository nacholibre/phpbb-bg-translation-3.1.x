...
$help = array(
	...
	array(
		...
		1 => 'Форумът пази вашия статус <em>Влязъл</em> само за кратко, след като активността ви престане (напр. затворите страницата с форумите). Това се прави, за да е сигурно, че никой няма да влиза от ваше име. Ако изберете опцията <em>Искам да влизам автоматично с всяко посещение</em> когато влизате, форумът ще запази статуса ви за винаги (или докато не натиснете Изход). Този подход, обаче, не се препоръчва в никакъв случай ако ползвате интернет от клуб, кафе, библиотека и прочие публични места, тъй като е възможно други хора да влязат на форума с вашия потребител.'
	),
	array(
		0 => 'Не искам името ми да се вижда в списъка Кой е онлайн. Как става това?',
		1 => 'Във вашия профил има специална опция за това: <em>Скриване на вашия онлайн статус</em>. Ако я включите, името ви ще бъде видимо само за администраторите и за вас. За останалите потребители ще сте Скрит.'
	),
	array(
	...
	array(
		...
		1 => 'Лесно, кликнете на съответния бутон на страницата на някой форум или тема. Може да се наложи да се регистрирате, за да пуснете тема. Какво ви е разрешено да правите във даден форум е показано в дъното на страницата на даден форум или тема (под формата на <em><strong>Можете</strong> да пускате нови теми, <strong>Не Можете</strong> да променяте съобщенията си</em> и т.н.)'
	),
	array(
		0 => 'Как да променя или изтрия мнение?',
		1 => 'Освен ако не сте администратор или модератор, можете да променяте или изтривате само собствените си мнения. Можете да промените съобщението си като кликнете на бутона <em>Промяна</em> за съответното мнение. Ако някой вече е отговорил на мнението ви, в дъното на мнението ви ще се появи кратък текст, който индикира колко пъти и кога за последно сте променили мнението си. Ако никой не е отговорил на съобщение ви, този текст не ви показва. Този текст няма да се показва и ако администратор или модератор е променил съобщението (те най-вероятно ще оставят съобщение какво и защо са променили). Моля забележете, че обикновените потребители не могат да изтриват мненията си след като им е било отговорено.'
	),
	array(
		0 => 'Как да добавя подпис към съобщенията си?',
		1 => 'За да добавите подпис към съобщение, първо трябва да си направите такъв. Това става във вашия Профил. След като си направите подпис, можете да включите опцията <em>Добави подпис</em> от формата за пускане на съобщение, за да добавите подписа в края на съобщението. Също така, можете да включите от Профила си опцията за автоматично добавяне на подписа.'
	),
	array(
		0 => 'Как да пусна анкета?',
		1 => 'Когато пускате нова тема, ще видите отделна форма за <em>Добавяне на анкета</em> точно под главната форма за писане на съобщение. Ако няма форма за добавяне на анкета, най-вероятно нямате такива права в този форум. Трябва да въведете заглавие на анкетата и поне два възможни отговора. За да добавите възможен отговор, въведете текст и натиснете бутона <em>Добавете възможен отговор</em>. Можете също да укажете време, за което анкетата да бъде активна, като 0 ще резултира в безкрайна анкета. Има лимит за възможните отговори, които можете да добавите, който се определя от администраторите.'
	),
	array(
	...
	array(
		...
		1 => 'Този софтуер е създаден и лицензиран от phpBB Group. За всякакви предложения относно форум системата phpBB посетете сайта <a href="https://area51.phpbb.com/">Area51</a>.'
	),
	array(
