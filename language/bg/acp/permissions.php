...
$lang = array_merge($lang, array(
	'ACP_PERMISSIONS_EXPLAIN'	=> '
        ...
        <p>Използват се за контрол на форумите. Разделени са на Форум права, Форум модератори, Потребителски форум права и Групови форум права.
        Повече информация можете да откриете тук <a href="https://www.phpbb.com/support/documentation/3.0/quickstart/quick_permissions.html">Глава 1.5 - Quick Start Guide</a></p>
